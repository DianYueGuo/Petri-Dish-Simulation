...
public:
    EatableCircle(const b2WorldId &worldId, float position_x = 0.0f, float position_y = 0.0f, float radius = 1.0f, float density = 1.0f, bool toxic = false, bool division_boost = false, float angle = 0.0f, bool boost_particle = false);
    void be_eaten();
    ...
    void set_division_boost(bool value) { division_boost = value; }
